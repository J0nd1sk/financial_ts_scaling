# Data Splits Protocol (HPO Phase)

> **ARCHIVED**: This document describes the data splitting approach used during HPO (Phase 6A, through January 2026). It uses "scattered" mode where val/test chunks are randomly distributed throughout the dataset. For final training, see `docs/data_splits_protocol.md` which covers the "contiguous" mode.
