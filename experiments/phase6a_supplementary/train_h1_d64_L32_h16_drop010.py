#!/usr/bin/env python3
"""
Supplementary Training: h1_d64_L32_h16_drop010
Purpose: n_heads sensitivity - h=16 on h1
Architecture: d_model=64, n_layers=32, n_heads=16, d_ff=256
...
EXPERIMENT_NAME = "h1_d64_L32_h16_drop010"
HORIZON = 1
