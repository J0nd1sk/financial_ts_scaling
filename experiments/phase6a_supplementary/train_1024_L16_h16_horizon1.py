#!/usr/bin/env python3
"""
Supplementary Training Experiment: 1024_L16_h16_horizon1
...
Rationale: New architecture test: d=1024, L=16 (201.8M params) on h1
...
EXPERIMENT_NAME = "1024_L16_h16_horizon1"
HORIZON = 1
TASK = "threshold_1pct"
