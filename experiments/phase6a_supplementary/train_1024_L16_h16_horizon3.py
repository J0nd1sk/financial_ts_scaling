#!/usr/bin/env python3
"""
Supplementary Training Experiment: 1024_L16_h16_horizon3
...
Horizon: 3-day prediction
Task: threshold_1pct (binary classification: >1% move)

Rationale: New architecture test: d=1024, L=16 (201.8M params) on h3
...
EXPERIMENT_NAME = "1024_L16_h16_horizon3"
HORIZON = 3
TASK = "threshold_1pct"
