#!/usr/bin/env python3
"""
Supplementary Training Experiment: 768_L28_h16_horizon1
...
Rationale: New architecture test: d=768, L=28 (198.7M params) on h1
...
EXPERIMENT_NAME = "768_L28_h16_horizon1"
HORIZON = 1
TASK = "threshold_1pct"
