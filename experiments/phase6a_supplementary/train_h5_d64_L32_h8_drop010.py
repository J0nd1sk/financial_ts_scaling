#!/usr/bin/env python3
"""
Supplementary Training: h5_d64_L32_h8_drop010
Purpose: n_heads sensitivity - h=8 on h5
Architecture: d_model=64, n_layers=32, n_heads=8, d_ff=256
...
EXPERIMENT_NAME = "h5_d64_L32_h8_drop010"
HORIZON = 5
