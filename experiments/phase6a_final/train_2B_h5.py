#!/usr/bin/env python3
"""
6A Final Training: 2B parameters, horizon=5
Type: Final Evaluation (fixed architecture and training params from HPO)
Generated: 2026-01-19T19:53:03.445310+00:00

Architecture (from HPO):
    d_model=1024, n_layers=180, n_heads=4, d_ff=4096

Training params (from HPO):
    lr=0.00025, dropout=0.22, weight_decay=0.0005
