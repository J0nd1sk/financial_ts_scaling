#!/usr/bin/env python3
"""
6A Final Training: 20M parameters, horizon=1
Type: Final Evaluation (fixed architecture and training params from HPO)
Generated: 2026-01-19T20:53:44.191007+00:00

Architecture (from HPO):
    d_model=128, n_layers=180, n_heads=16, d_ff=512

Training params (from HPO):
    lr=0.00055, dropout=0.2, weight_decay=0.0008
