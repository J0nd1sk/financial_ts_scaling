#!/usr/bin/env python3
"""
6A Final Training: 200M parameters, horizon=5
Type: Final Evaluation (fixed architecture and training params from HPO)
Generated: 2026-01-19T19:53:03.442053+00:00

Architecture (from HPO):
    d_model=256, n_layers=256, n_heads=16, d_ff=1024
