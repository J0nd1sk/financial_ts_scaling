#!/usr/bin/env python3
"""
6A Final Training: 20M parameters, horizon=5
Type: Final Evaluation (fixed architecture and training params from HPO)
Generated: 2026-01-19T20:53:44.194191+00:00

Architecture (from HPO):
    d_model=384, n_layers=12, n_heads=4, d_ff=1536
