#!/usr/bin/env python3
"""
6A Final Training: 20M parameters, horizon=3
Type: Final Evaluation (fixed architecture and training params from HPO)
Generated: 2026-01-19T19:53:03.437609+00:00

Architecture (from HPO):
    d_model=256, n_layers=32, n_heads=2, d_ff=1024
