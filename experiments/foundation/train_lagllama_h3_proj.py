#!/usr/bin/env python3
"""
Foundation Investigation: Lag-Llama H3, Feature Projection (FD-02b)
...
EXPERIMENT_NAME = "lagllama_h3_proj"
HORIZON = 3
...
def main():
    print("=" * 70)
    print(f"FOUNDATION INVESTIGATION: Lag-Llama / H{HORIZON} / Feature Projection (FD-02b)")
    print("=" * 70)
    ...
    model = LagLlamaWrapper(
        ...
        prediction_length=1,
        threshold=0.01,
        num_features=NUM_FEATURES,  # Enables learnable projection
        fine_tune_mode="full",
        dropout=0.1,
    )
