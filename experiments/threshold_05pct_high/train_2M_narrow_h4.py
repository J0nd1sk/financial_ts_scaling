#!/usr/bin/env python3
"""
0.5% Threshold with HIGH-based Targets: 2M Narrow-Deep h=4
Purpose: Test if h=4 improves over h=2 at 2M scale
Architecture: d=64, L=32, h=4 (~2M params)

Comparison experiment: At 20M scale, h=4 performed best. Does this hold at 2M?
"""
...
EXPERIMENT_NAME = "2M_narrow_h4_threshold_05pct_HIGH"
TASK = "threshold_0.5pct"
HORIZON = 1

# Architecture: 2M narrow-deep with h=4
D_MODEL = 64
N_LAYERS = 32
N_HEADS = 4  # Changed from h=2
D_FF = 256  # 4 * d_model
CONTEXT_LENGTH = 80
...
def main():
    ...
    print("-" * 56)
    print(f"{'2M h=4 (this)':<20} {test_auc:<12.4f} {test_accuracy:<12.4f} {test_f1:<12.4f}")
