#!/usr/bin/env python3
"""
0.5% Threshold with HIGH-based Targets: 20M_wide h=4
Purpose: Compare n_heads=4 vs n_heads=8 with correct HIGH-based targets
Architecture: d=512, L=6, h=4 (20M_wide variant with fewer heads)
Target: max(HIGH[t+1:t+horizon]) >= CLOSE[t] * 1.005

This is the h=4 variant for comparison with h=8.
"""
...
EXPERIMENT_NAME = "20M_wide_h4_threshold_05pct_HIGH"
TASK = "threshold_0.5pct"
HORIZON = 1

# Architecture: 20M_wide with h=4 (fewer heads)
D_MODEL = 512
N_LAYERS = 6
N_HEADS = 4  # Changed from 8
D_FF = 2048
CONTEXT_LENGTH = 80
DROPOUT = 0.5
