#!/usr/bin/env python3
"""
Threshold Comparison: 2% (balanced classes)
...
EXPERIMENT_NAME = "threshold_2pct"
TASK = "threshold_2pct"  # 2% threshold - balanced classes (~6% positive)
HORIZON = 1
...
def main():
    ...
    print(f"Task: {TASK} (expecting ~6% positive class)")
    print("=" * 70)
