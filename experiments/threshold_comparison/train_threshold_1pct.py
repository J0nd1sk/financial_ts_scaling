#!/usr/bin/env python3
"""
Threshold Comparison: 1% (balanced classes)
...
EXPERIMENT_NAME = "threshold_1pct"
TASK = "threshold_1pct"  # 1% threshold - balanced classes (~24% positive)
HORIZON = 1
...
def main():
    ...
    print(f"Task: {TASK} (expecting ~24% positive class)")
    print("=" * 70)
