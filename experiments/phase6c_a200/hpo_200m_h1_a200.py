#!/usr/bin/env python3
"""
Phase 6C A200 HPO: 200M parameters, horizon=1

Hyperparameter optimization for architecture and training within 200M budget.
...
EXPERIMENT_NAME = "hpo_200m_h1_a200"
BUDGET = "200M"
HORIZON = 1
N_TRIALS = 50

# Search space (within 200M budget)
SEARCH_SPACE = {
    # Architecture
