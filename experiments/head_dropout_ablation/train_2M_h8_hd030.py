#!/usr/bin/env python3
"""
Head Dropout Ablation: 2M h=8 with head_dropout=0.30
Purpose: Test effect of heavy head dropout on best 2M architecture
...
HEAD_DROPOUT = 0.30  # <-- VARIABLE UNDER TEST
