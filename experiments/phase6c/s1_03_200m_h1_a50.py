#!/usr/bin/env python3
"""
Phase 6C Stage 1: a50 Baseline - 200M parameters, horizon=1
...
EXPERIMENT_NAME = "s1_03_200m_h1_a50"
BUDGET = "200M"
HORIZON = 1
...
def main():
    ...
    print(f"  Phase 6A 200M H1 AUC: 0.718")
    print(f"  Phase 6C 200M H1 AUC: {val_metrics['auc']:.3f}" if val_metrics['auc'] else "  Phase 6C: N/A")
    if val_metrics['auc']:
        delta = (val_metrics['auc'] - 0.718) / 0.718 * 100
