#!/usr/bin/env python3
"""
Phase 6C Stage 2: Architecture Experiment - 200M budget, wide but shallow

Tests if wider but shallower network helps with 55 features.

Architecture Change:
    d=384 (from 256), L=4 (from 8), h=8 - Wider embedding but fewer layers
...
EXPERIMENT_NAME = "s2_arch_200m_h1_wide"
BUDGET = "200M"
HORIZON = 1

# Architecture - MODIFIED: wider d_model, shallower
...
def main():
    print("=" * 70)
    print(f"PHASE 6C STAGE 2: {BUDGET} / horizon={HORIZON} / ARCH: wide d={D_MODEL}")
    print("=" * 70)
