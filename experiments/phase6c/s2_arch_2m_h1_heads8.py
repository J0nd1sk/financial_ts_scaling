#!/usr/bin/env python3
"""
Phase 6C Stage 2: Architecture Experiment - 2M budget, doubled heads

Tests if more attention heads improve feature mixing with 55 features.

Architecture Change:
    h=8 (from 4), d=64, L=3 - Double heads for better feature interaction

Baseline (S1 2M H1 a50): AUC=0.708, Precision=50%
"""
import sys
import json
import time
...
EXPERIMENT_NAME = "s2_arch_2m_h1_heads8"
BUDGET = "2M"
HORIZON = 1

# Architecture - MODIFIED: doubled heads, reduced layers
D_MODEL = 64
...
# Baseline for comparison (S1 2M result)
BASELINE_AUC = 0.708
