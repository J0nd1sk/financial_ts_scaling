#!/usr/bin/env python3
"""
Phase 6C Stage 2: Architecture Experiment - 200M budget, shallow network

Tests if reducing depth prevents overfitting with 55 features.

Architecture Change:
    L=4 (from 8), d=256, h=8 - Shallower network to reduce overfitting
...
EXPERIMENT_NAME = "s2_arch_200m_h1_shallow"
BUDGET = "200M"
HORIZON = 1

# Architecture - MODIFIED: half the layers
D_MODEL = 256
N_LAYERS = 4   # Halved from 8
N_HEADS = 8
D_FF = 1024
...
def main():
    print("=" * 70)
    print(f"PHASE 6C STAGE 2: {BUDGET} / horizon={HORIZON} / ARCH: shallow L={N_LAYERS}")
    print("=" * 70)
