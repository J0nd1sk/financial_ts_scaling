#!/usr/bin/env python3
"""
Phase 6C Stage 2: Training Parameter Experiment - 200M, dropout=0.3

Tests if lower dropout helps fix 200M regression with 55 features.
...
EXPERIMENT_NAME = "s2_train_200m_h1_drop03"
BUDGET = "200M"
HORIZON = 1
...
# Hyperparameters - MODIFIED: lower dropout
LEARNING_RATE = 1e-4
