#!/usr/bin/env python3
"""
Phase 6C Stage 2: Training Parameter Experiment - 20M, dropout=0.3

Tests if lower dropout helps with 55 features (less regularization).
...
EXPERIMENT_NAME = "s2_train_20m_h1_drop03"
BUDGET = "20M"
HORIZON = 1
