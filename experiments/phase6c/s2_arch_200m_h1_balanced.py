#!/usr/bin/env python3
"""
Phase 6C Stage 2: Architecture Experiment - 200M budget, balanced config

Tests a moderate width/depth balance with 55 features.

Architecture Change:
    d=320, L=6, h=8 - Moderate width increase, moderate depth
...
EXPERIMENT_NAME = "s2_arch_200m_h1_balanced"
BUDGET = "200M"
HORIZON = 1

# Architecture - MODIFIED: balanced width/depth
D_MODEL = 320   # Moderate increase from 256
N_LAYERS = 6    # Moderate reduction from 8
N_HEADS = 8
...
def main():
    print("=" * 70)
    print(f"PHASE 6C STAGE 2: {BUDGET} / horizon={HORIZON} / ARCH: balanced d={D_MODEL} L={N_LAYERS}")
    print("=" * 70)
