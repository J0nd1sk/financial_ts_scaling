#!/usr/bin/env python3
"""
Phase 6C Stage 2: Training Parameter Experiment - 200M, weight_decay=1e-4

Tests if L2 regularization helps fix 200M regression with 55 features.

Training Change:
    weight_decay=1e-4 (from 0) - Mild L2 regularization
...
EXPERIMENT_NAME = "s2_train_200m_h1_wd1e4"
BUDGET = "200M"
HORIZON = 1
...
# Hyperparameters - MODIFIED: added weight decay
LEARNING_RATE = 1e-4
DROPOUT = 0.5
CONTEXT_LENGTH = 80
