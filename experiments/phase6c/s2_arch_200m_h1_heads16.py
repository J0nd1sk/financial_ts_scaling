#!/usr/bin/env python3
"""
Phase 6C Stage 2: Architecture Experiment - 200M budget, 16 heads

Tests if more attention heads can fix 200M regression with 55 features.

Architecture Change:
    h=16 (from 8), d=256, L=8 - More heads might help with feature mixing
...
EXPERIMENT_NAME = "s2_arch_200m_h1_heads16"
BUDGET = "200M"
HORIZON = 1

# Architecture - MODIFIED: doubled heads
D_MODEL = 256
N_LAYERS = 8
N_HEADS = 16   # Doubled from 8
D_FF = 1024
...
def main():
    print("=" * 70)
    print(f"PHASE 6C STAGE 2: {BUDGET} / horizon={HORIZON} / ARCH: heads={N_HEADS}")
    print("=" * 70)
