#!/usr/bin/env python3
"""
Phase 6C Stage 2: Training Parameter Experiment - 200M, lr=5e-5

Tests if lower learning rate helps fix 200M regression with 55 features.

Training Change:
    lr=5e-5 (from 1e-4) - Slower convergence might help
...
EXPERIMENT_NAME = "s2_train_200m_h1_lr5e5"
BUDGET = "200M"
HORIZON = 1
...
# Hyperparameters - MODIFIED: lower learning rate
...
def main():
    print("=" * 70)
    print(f"PHASE 6C STAGE 2: {BUDGET} / horizon={HORIZON} / TRAIN: lr={LEARNING_RATE}")
    print("=" * 70)
