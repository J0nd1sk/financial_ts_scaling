#!/usr/bin/env python3
"""
Phase 6C Stage 2: Training Parameter Experiment - 200M, lr=2e-4

Tests if higher learning rate helps fix 200M regression with 55 features.

Training Change:
    lr=2e-4 (from 1e-4) - Faster convergence
...
EXPERIMENT_NAME = "s2_train_200m_h1_lr2e4"
BUDGET = "200M"
HORIZON = 1
...
# Hyperparameters - MODIFIED: higher learning rate
