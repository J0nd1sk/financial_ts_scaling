#!/usr/bin/env python3
"""
Phase 6C Stage 2: Training Parameter Experiment - 200M, dropout=0.7

Tests if higher dropout helps fix 200M regression with 55 features.

Training Change:
    dropout=0.7 (from 0.5)
...
EXPERIMENT_NAME = "s2_train_200m_h1_drop07"
BUDGET = "200M"
HORIZON = 1
...
# Hyperparameters - MODIFIED: higher dropout
LEARNING_RATE = 1e-4
...
def main():
    print("=" * 70)
    print(f"PHASE 6C STAGE 2: {BUDGET} / horizon={HORIZON} / TRAIN: dropout={DROPOUT}")
    print("=" * 70)
