#!/usr/bin/env python3
"""
Phase 6C Stage 1: a50 Baseline - 2M parameters, horizon=1

Tests feature scaling hypothesis: Does 55 features improve over 25 at same architecture?

Architecture (inherited from Phase 6A 2M):
...
EXPERIMENT_NAME = "s1_01_2m_h1_a50"
BUDGET = "2M"
HORIZON = 1
...
def main():
    ...
    print(f"  Phase 6A 2M H1 AUC: 0.706")
    print(f"  Phase 6C 2M H1 AUC: {val_metrics['auc']:.3f}" if val_metrics['auc'] else "  Phase 6C: N/A")
    if val_metrics['auc']:
        delta = (val_metrics['auc'] - 0.706) / 0.706 * 100
