#!/bin/bash
#
# Phase 6A HPO Runner Script - 20M Budget Only
# Runs 20M HPO experiments (can run in parallel with larger models)
#
# Experiments:
#   1-3: 20M_h{1,3,5}
#
# Usage:
#   tmux new-window -t hpo -n 20M
#   ./scripts/run_phase6a_20M.sh
...
LOG_FILE="${LOG_DIR}/phase6a_20M_${TIMESTAMP}.log"
...
preflight_check() {
    ...
    echo -n "  Memory (>8GB free for 20M): "
    ...
    if [ -n "$FREE_MEM_GB" ]; then
        ...
        elif [ "$FREE_MEM_INT" -ge 4 ]; then
            echo "WARNING (${FREE_MEM_GB}GB - may be tight)"
        else
...
echo ""
echo "============================================================"
echo "Phase 6A HPO Runner - 20M Budget Only"
echo "============================================================"
echo "Started: $(date)"
...
echo "============================================================"
echo "Starting 20M Experiment Queue"
echo "============================================================"
echo ""
